...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\USER\PycharmProjects\Traditional_RAG_Project\RAG_Project'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\USER\PycharmProjects\Traditional_RAG_Project\RAG_Project\Scripts\deactivate.nu'
